    ...
    <div class="row justify-content-center">
                    ...
                    <table class="table aling-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-success"><a href="editarUsuario.php?id=<?php echo $dato->id_usuario; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td class="text-danger"><i class="bi bi-trash3"></i></td>
                            </tr>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <form action="usuario.php" class="p-4" method="POST" >
                    <div class="mb-3">
